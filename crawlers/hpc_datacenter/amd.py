"""
AMD 뉴스룸 크롤러 — GPU / EPYC / AI 가속기 관련 신호 수집.
소스 1 (RSS 시도): https://ir.amd.com/rss/news-releases.xml
소스 2 (HTML 폴백): https://ir.amd.com/news-events/press-releases
"""
...
_RSS_URL = "https://ir.amd.com/rss/news-releases.xml"
_HTML_URL = "https://ir.amd.com/news-events/press-releases"
_SOURCE_NAME = "AMD Newsroom"
...
class AmdCrawler(BaseCrawler):
    ...
    def _parse_html(self, raw: str) -> list[RefinedSignal]:
        ...
        for item in items:
            ...
            url = href if href.startswith("http") else f"https://ir.amd.com{href}"
